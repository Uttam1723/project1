...
<head>
  ...
  <style>
          ...
          /* Card styles for sessions and attendance */
          .card {
            background: #ffffff;
            border-radius: 8px;
            padding: 16px;
          ...
          /* Tables full width with spacing */
          .card table {
            width: 100%;
          ...
          /* Buttons highlight important actions */
          button {
            padding: 10px 16px;
            border-radius: 4px;
            border: none;
          ...
          button.secondary { background: #f4f4f4; color: #333; margin-left: 8px; }
